...
/**
 * Text Search (New) - find places matching a query.
 * Returns up to 60 results per call.
 */
export async function textSearch(
  ...
  incrementQuota("google-places", 1);
...
/**
 * Place Details (New) - get full details for a place.
 * Returns name, address, phone, website, hours, reviews, etc.
 */
...
/**
 * Convenience: get the API key from the tool_configs table.
